...
class GetDataPoints200ResponseDataInnerToday(BaseModel):
    """
    GetDataPoints200ResponseDataInnerToday
    """
    solar: Optional[Union[StrictFloat, StrictInt]] = None
    grid: Optional[GetDataPoints200ResponseDataInnerTodayGrid] = None
    battery: Optional[GetDataPoints200ResponseDataInnerTodayBattery] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDataPoints200ResponseDataInnerToday:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDataPoints200ResponseDataInnerToday:
        """Create an instance of GetDataPoints200ResponseDataInnerToday from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDataPoints200ResponseDataInnerToday.parse_obj(obj)

        _obj = GetDataPoints200ResponseDataInnerToday.parse_obj({
            "solar": obj.get("solar"),
            "grid": GetDataPoints200ResponseDataInnerTodayGrid.from_dict(obj.get("grid")) if obj.get("grid") is not None else None,
            "battery": GetDataPoints200ResponseDataInnerTodayBattery.from_dict(obj.get("battery")) if obj.get("battery") is not None else None,
