...
class GetEVChargerByUUID200ResponseData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetEVChargerByUUID200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetEVChargerByUUID200ResponseData:
        """Create an instance of GetEVChargerByUUID200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetEVChargerByUUID200ResponseData.parse_obj(obj)

        _obj = GetEVChargerByUUID200ResponseData.parse_obj({
            "uuid": obj.get("uuid"),
