...
class GetAccountInformationByID200ResponseData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAccountInformationByID200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAccountInformationByID200ResponseData:
        """Create an instance of GetAccountInformationByID200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAccountInformationByID200ResponseData.parse_obj(obj)

        _obj = GetAccountInformationByID200ResponseData.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "role": obj.get("role"),
            "email": obj.get("email"),
