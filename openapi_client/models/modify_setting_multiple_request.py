...
class ModifySettingMultipleRequest(BaseModel):
    """
    ...
    __properties = ["inverter_serials", "setting_id", "value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifySettingMultipleRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifySettingMultipleRequest:
        """Create an instance of ModifySettingMultipleRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModifySettingMultipleRequest.parse_obj(obj)

        _obj = ModifySettingMultipleRequest.parse_obj({
