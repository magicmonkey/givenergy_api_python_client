...
class GetYourAccountChildrenInformation200ResponseDataInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetYourAccountChildrenInformation200ResponseDataInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetYourAccountChildrenInformation200ResponseDataInner:
        """Create an instance of GetYourAccountChildrenInformation200ResponseDataInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetYourAccountChildrenInformation200ResponseDataInner.parse_obj(obj)

        _obj = GetYourAccountChildrenInformation200ResponseDataInner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "role": obj.get("role"),
            "email": obj.get("email"),
