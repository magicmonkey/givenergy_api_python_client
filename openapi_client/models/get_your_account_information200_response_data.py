...
class GetYourAccountInformation200ResponseData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetYourAccountInformation200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetYourAccountInformation200ResponseData:
        """Create an instance of GetYourAccountInformation200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetYourAccountInformation200ResponseData.parse_obj(obj)

        _obj = GetYourAccountInformation200ResponseData.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "role": obj.get("role"),
            "email": obj.get("email"),
