...
class GetDataPoints200ResponseDataInnerPowerBattery(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDataPoints200ResponseDataInnerPowerBattery:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDataPoints200ResponseDataInnerPowerBattery:
        """Create an instance of GetDataPoints200ResponseDataInnerPowerBattery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDataPoints200ResponseDataInnerPowerBattery.parse_obj(obj)

        _obj = GetDataPoints200ResponseDataInnerPowerBattery.parse_obj({
