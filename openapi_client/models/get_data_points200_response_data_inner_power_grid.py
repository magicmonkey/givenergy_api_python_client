...
class GetDataPoints200ResponseDataInnerPowerGrid(BaseModel):
    """
    GetDataPoints200ResponseDataInnerPowerGrid
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDataPoints200ResponseDataInnerPowerGrid:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDataPoints200ResponseDataInnerPowerGrid:
        """Create an instance of GetDataPoints200ResponseDataInnerPowerGrid from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDataPoints200ResponseDataInnerPowerGrid.parse_obj(obj)

        _obj = GetDataPoints200ResponseDataInnerPowerGrid.parse_obj({
